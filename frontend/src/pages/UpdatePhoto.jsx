...
import { getPhotoById, updatePhoto } from "../client";
...
export default function CreatePhoto() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (+formData.regularPrice < +formData.discountPrice) setLoading(true);
      setError(false);
      const data = await updatePhoto(params, formData);
      setLoading(false);
      if (data.success === false) {
